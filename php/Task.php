	...
	function viewContact(){
      ...
      $query="select * from  contacts";
		...
		function editContact(){
						...
						$row1=mysqli_fetch_array($result);
						print_r($row1);
						$condition=$row1['ContactId'];
						echo "enter the field you want to edit\n";
						$field=readline();
						echo "enter the value you want to enter in that field\n";
						$value=readline();
						$query1="update contacts set $field='$value' where ContactId='$condition'";
						$result=mysqli_query($connection, $query1) or die("error in inserting data" . mysqli_error($connection));
						mysqli_close($connection);
						echo "if you want to continue press Y or you want to exit press N\n";
						$s=readline();
...
function editCase(){
        ...
        $row1=mysqli_fetch_array($result);
        print_r($row1);
        $condition=$row1['Case_Number'];
        $account=$row1['Account_Name'];
        echo "enter the field you want to edit\n";
        $field=readline();
        echo "enter the value you want to enter in that field\n";
        $value=readline();
        $query="update cases set $field="$value" where Case_Number="$condition"";
        $result=mysqli_query($connection, $query) or die('error in inserting data');
        mysqli_close($connection);
        echo "if you want to continue press Y or you want to exit press N\n";
        $s=readline();
